  ...
  render() {
    return (
      <View style={styles.container}>
        <Image style={{aspectRatio:0.5,resizeMode: 'contain'}} source={require('../resources/icon.png')}/> 
        ...
        <View style = {{alignItems: 'center',flexDirection:'row', paddingBottom:10}}>
          <View style = {{paddingRight:30,}}>  
            <TouchableOpacity style = {styles.intButton} onPress={() => this.props.navigation.navigate('Home')}>
